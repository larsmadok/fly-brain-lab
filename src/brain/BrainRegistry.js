export const BRAINS={
 ...
 fafb:{id:'fafb',name:'Drosophila FAFB v783',neurons:139255,status:'runtime-preparing'},
 fafbPlastic:{id:'fafbPlastic',name:'Drosophila FAFB + Plasticity',neurons:139255,status:'runtime-preparing'}
};
